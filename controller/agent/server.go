...
func (s *Server) Router() http.Handler {
	...
	r.Group(func(r chi.Router) {
		...
		r.Post("/admin/core/start", s.coreStart)
		r.Post("/admin/core/stop", s.coreStop)
		r.Post("/admin/core/restart", s.coreRestart)
		r.Post("/admin/core/xray-version", s.setXrayVersion)
		r.Post("/admin/node/update", s.selfUpdate)
